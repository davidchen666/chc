	...
	var showData = function(res){
		...
		if(res.reviewData){
			$.each(res.reviewData, function(index, val) {
				 reviewStr += '<li class="wow"><div class="box1CenCon" style="height:300px;"><img style="height:200px" src="<?php
echo $_obj['imgPath'];
?>
/events/'+ val.past_pic +'" class="img-responsive"><p>' + val.past_title + '</p></div></li>'
			});
		}
