...
<script src="{WEBSITE_SOURCE_URL}/resources/plugins/jquery.1.12.4.min.js"></script>
    ...
    <script src="{WEBSITE_SOURCE_URL}/resources/plugins/bootstrap-table-1.11.0/bootstrap-table.min.js"></script>
    <script src="{WEBSITE_SOURCE_URL}/resources/plugins/bootstrap-table-1.11.0/locale/bootstrap-table-zh-CN.min.js"></script>
    <script src="{WEBSITE_SOURCE_URL}/resources/plugins/waves-0.7.5/waves.min.js"></script>
    <script src="{WEBSITE_SOURCE_URL}/resources/plugins/jquery-confirm/jquery-confirm.min.js"></script>
    <script src="{WEBSITE_SOURCE_URL}/resources/plugins/select2/js/select2.min.js"></script>
    <script src="{WEBSITE_SOURCE_URL}/resources/js/common.js"></script>
...
$(function() {
    ...
    $table.bootstrapTable({
        url: '/chc-admin/public/resources/data/data1.json',
        height: getHeight(),
        striped: true,
        search: true,
