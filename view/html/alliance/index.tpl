...
<div class="banner">
    <div class="swiper-container">
        <div class="swiper-wrapper">
                ...
                <div class="banBg imgFull"><img src="{WEBSITE_SOURCE_URL}/img/alliance/banner-00.png" class="img-responsive"></div>
...
<div class="box1Bg box1Cen" id="alliance-bg">
	<div class="container ">
        <div class="box1Top wow fadeInUp" data-wow-delay="0.5s">
        	<img src="{WEBSITE_SOURCE_URL}/img/alliance/about-alliance.png" class="img-responsive">
    	</div>
        ...
        <div class="box1Top wow" data-wow-delay="0.5s">
            <img src="{WEBSITE_SOURCE_URL}/img/alliance/member-title.png" class="img-responsive">
        </div>
        ...
        <div class="btn-img text-center">
            <a href="javascript:;" data-target="#showMember" data-toggle="modal"><img src="{WEBSITE_SOURCE_URL}/img/alliance/learn-more.png" alt=""></a>
        </div>
        <!--end 联盟成员-->
        ...
        <!--begin 入会资格流程-->
        <div class="box1Top wow" data-wow-delay="0.5s">
            <img src="{WEBSITE_SOURCE_URL}/img/alliance/enter-alliance-title.png" class="img-responsive">
        </div>
        ...
        <div class="btn-img text-center">
            <a href="javascript:;" data-target="#showRegister" data-toggle="modal"><img src="{WEBSITE_SOURCE_URL}/img/alliance/enter-alliance.png" alt=""></a>
        </div>
	</div>
</div>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="showRegisterModalLabel" id="showRegister" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12 text-center"><img src="{WEBSITE_SOURCE_URL}/img/alliance/apply-title.png" alt=""></div>
        </div>
        <div class="row">
          <div class="col-md-12">
