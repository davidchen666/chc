<footer class="footerBg">
    <div class="footTop">
    	<div class="container">
        	<!-- <div id="ctl00_footLogo" class="footLogo"><img src="{WEBSITE_SOURCE_URL}/img/home/logo.png" class='img-responsive'/></div>
    		<div class="footCon">
            	<h3>电话</h3>
                <p>021-50726900 </p>
            </div>
            ...
            <div class="footShare">
                ...
                <ul class="share list-unstyled list-inline">
                    <li>
                        <a href="javascript:;"><img src="{WEBSITE_SOURCE_URL}/default/images/footIco1.png" class="img-responsive" alt="新浪"></a>
                        <div class="shareWx">
                        	<img src="{WEBSITE_SOURCE_URL}/img/home/wechat.png" class="img-responsive" alt="关注我们">
                        </div>
                    </li>
                    <li>
                        <a href="javascript:;"><img src="{WEBSITE_SOURCE_URL}/default/images/footIco2.png" class="img-responsive" alt="微信"></a>
                        <div class="shareWx"><img src="{WEBSITE_SOURCE_URL}/img/home/weibo.png" class="img-responsive" alt="关注我们"></div>
                    </li>
                </ul>
            </div> -->
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-5 col-sm-3 text-center">
                            <img src="{WEBSITE_SOURCE_URL}/img/home/wechat.png" width="78px" alt="">
                            <p>微信公众号</p>
                        </div>
                        <!-- <div class="col-md-1"></div> -->
                        <div class="col-md-4 col-sm-3 text-center">
                            <img src="{WEBSITE_SOURCE_URL}/img/home/weibo.png" width="78px" alt="">
                            <p>新浪微博</p>
                        </div>
                    </div>
                </div>
...
<script language="javascript" type="text/javascript" src="{WEBSITE_SOURCE_URL}/default/js/qz.ad.floating.js"></script>
<script language="javascript" type="text/javascript" src="{WEBSITE_SOURCE_URL}/default/js/qz.ad.popup.js"></script>
<script language="javascript" type="text/javascript" src="{WEBSITE_SOURCE_URL}/default/js/qz.ad.screen.js"></script>
<script src="{WEBSITE_SOURCE_URL}/default/js/slick.min.js"></script> 
