...
<head>
	...
	<link href="{WEBSITE_SOURCE_URL}/resources/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
	<link href="{WEBSITE_SOURCE_URL}/resources/css/login.css" rel="stylesheet"/>
</head>
<body>
<div id="login-window">
...
<script src="{WEBSITE_SOURCE_URL}/resources/plugins/checkbix/js/checkbix.min.js"></script>

<script src="{WEBSITE_SOURCE_URL}/resources/js/login.js"></script>
