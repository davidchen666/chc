            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(5), __webpack_require__(6), __webpack_require__(7), __webpack_require__(8), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Highlighter, History, SearchBox, Node, modeswitcher, util) {
                    ...
                    treemode._onKeyDown = function (event) {
                        ...
                        //快捷键ctrl+q
                        if (ctrlKey && !shiftKey && keynum == 81) { // Ctrl+q
                            alert("提示");
                            handled = true;
                        }
                        if (handled) {
                        ...
                        if (target == domValue) {
                            ...
                            switch (type) {
                                ...
                                case 'click':
                                    ...
                                    this.editor.options.showTab(this);
                                    break;
                    ...
                    Node.prototype.showContextMenu = function (anchor, onClose) {
                        ...
                        if (this.parent && this.parent._hasChilds()) {
                            ...
                            if (node == childs[childs.length - 1]) {
                                items.push({
                                    'text': '添加',
                                    'title': '在当前字段后增加一个新的字段，字段类型为 \'自动\' (Ctrl+Shift+Ins)',
                                    'submenuTitle': '选择字段类型',
                                    'className': 'append',
                                    'click': function () {
                                        node._onAppend('', '', 'auto');
                            ...
                            items.push({
                                'text': '插入',
                                'title': '在当前字段前增加一个新的字段，字段类型为 \'自动\' (Ctrl+Ins)',
                                'submenuTitle': '选择字段类型',
                                'className': 'insert',
                                'click': function () {
