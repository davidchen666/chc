define(function (require, exports, module) {
    require('../weekselect/weekselect.js');
    require('../weekselect/module.js');
    /**
     * @version: 1.2
    ...
    !function ($) {
        ...
        var DateRangePicker = function (element, options, cb) {
            ...
            selectweekObject = this.selectweek;
            ...
            if (hasOptions) {
                ...
                //周选择
                if (typeof options.selectweek == 'object') {
                    $.each(selectweekObject, function (property, value) {
                        selectweekObject[property] = options.selectweek[property] || value;
                    });
                }
            ...
            if (hasOptions) {
                ...
                if (typeof options.ranges == 'object') {
                    ...
                    //周选择
                    list += '<li id="selectweek_session">' + options.selectweek.title + '</li>';
                    list += '</ul>';
        ...
        DateRangePicker.prototype = {
            ...
            enterRange: function (e) {
                ...
                if (label == this.locale.customRangeLabel) {
                    this.updateView();
                } else if (label == this.selectweek.title) {
                    //@todo: 周选择时候鼠标放上去的事件
                    this.updateView();
            ...
            //显示周选择
            showSelectWeek: function () {
                $p.plugin.weekselect("#selectweek_session", this.selectweek);
                this.container.removeTag(".modal-dialog ");
